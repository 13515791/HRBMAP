...
static CGFloat const kQuadCurveMenuDefaultStartPointY = 430.0;
static CGFloat const kQuadCurveMenuDefaultTimeOffset = 0.036f;
static CGFloat const kQuadCurveMenuDefaultRotateAngle = 0.0;
static CGFloat const kQuadCurveMenuDefaultMenuWholeAngle = M_PI * 3/5;
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        // add the "Add" Button.
		NSBundle *bundle = [NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"QuadCurve" ofType:@"bundle"]];

		[UIImage imageWithContentsOfFile:[bundle pathForResource:@"icon-star" ofType:@"png"]];

        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageWithContentsOfFile:[bundle pathForResource:@"bg-addbutton" ofType:@"png"]]
                                       highlightedImage:[UIImage imageWithContentsOfFile:[bundle pathForResource:@"bg-addbutton-highlighted" ofType:@"png"]] 
                                           ContentImage:[UIImage imageWithContentsOfFile:[bundle pathForResource:@"icon-plus" ofType:@"png"]]
                                highlightedContentImage:[UIImage imageWithContentsOfFile:[bundle pathForResource:@"icon-plus-highlighted" ofType:@"png"]]];
